...
from src.scrapers.lever_scraper import scrape_lever, determine_listing_type as lever_determine_listing_type
from src.scrapers.greenhouse_scraper import scrape_greenhouse, determine_listing_type as gh_determine_listing_type
...
def test_lever_extraction(mock_sleep, mock_db, mock_playwright):
    ...
    def query_selector_side_effect(selector):
        if "h2" in selector:
            ...
            return mock_loc
        elif "content" in selector or "section-wrapper" in selector or "job-description" in selector:
            return mock_jd
        return None
